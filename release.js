...
function detect_release_candidate() {
    const branch = '*** master 2026-05-19***';// 'release candidate';
    const release_candidate = 'https://github.com/OSGeo/PROJ/actions/runs/26088307862'; // leave this empty for normal releases
