...
function detect_release_candidate() {
    const branch = '*** master 2026-06-19***';// 'release candidate';
    const release_candidate = 'https://github.com/OSGeo/PROJ/actions/runs/27836694735'; // leave this empty for normal releases
